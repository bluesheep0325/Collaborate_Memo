...
- Multiple pages per room, page search, title editing, duplication, drag-and-drop reordering, deletion, and restore.
- Markdown preview plus selected-text bold, color, and size markup.
